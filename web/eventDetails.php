...
// -------
//
function ciniki_filmschedule_web_eventDetails($ciniki, $settings, $tnid, $permalink) {
...
//  print "<pre>" . print_r($ciniki, true) . "</pre>";
    ...
    if( !isset($rc['events']) || count($rc['events']) < 1 ) {
        return array('stat'=>'404', 'err'=>array('code'=>'ciniki.filmschedule.23', 'msg'=>"I'm sorry, but we can't find the event you requested."));
    }
