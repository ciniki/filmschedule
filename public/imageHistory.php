...
function ciniki_filmschedule_imageHistory($ciniki) {
    ...
    $rc = ciniki_filmschedule_checkAccess($ciniki, $args['tnid'], 'ciniki.filmschedule.imageHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.filmschedule', 'ciniki_filmschedule_history', 
        $args['tnid'], 'ciniki_filmschedule_images', $args['event_image_id'], $args['field']);
}
?>
