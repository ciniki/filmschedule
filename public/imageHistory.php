...
//  </users>
//
function ciniki_filmschedule_imageHistory($ciniki) {
    //
    ...
    $rc = ciniki_filmschedule_checkAccess($ciniki, $args['business_id'], 'ciniki.filmschedule.imageHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.filmschedule', 'ciniki_filmschedule_history', 
        $args['business_id'], 'ciniki_filmschedule_images', $args['event_image_id'], $args['field']);
}
?>
