    ...
    if( $args['event_id'] == 0 ) {
        ...
        if( isset($args['images']) && $args['images'] == 'yes' ) {
            ...
            if( !isset($rc['events']) || !isset($rc['events'][0]) ) {
                return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.filmschedule.6', 'msg'=>'Unable to find event'));
            }
            ...
            if( !isset($rc['events']) || !isset($rc['events'][0]) ) {
                return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.filmschedule.7', 'msg'=>'Unable to find event'));
            }
            $event = $rc['events'][0]['event'];
        }
