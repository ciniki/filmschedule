...
//
function ciniki_filmschedule_eventNew($ciniki) {
    //  
    ...
    $rc = ciniki_filmschedule_checkAccess($ciniki, $args['tnid'], 'ciniki.filmschedule.eventNew'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    $modules = $rc['modules'];
    ...
    //
    $categories = array();
    if( ($ciniki['tenant']['modules']['ciniki.filmschedule']['flags']&0x10) > 0
        ...
        $rc = ciniki_core_tagsList($ciniki, 'ciniki.filmschedule', $args['tnid'], 
