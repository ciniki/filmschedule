...
function ciniki_filmschedule_eventUpdate(&$ciniki) {
    ...
    $rc = ciniki_filmschedule_checkAccess($ciniki, $args['tnid'], 'ciniki.filmschedule.eventUpdate'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    $rc = ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.filmschedule.event', $args['event_id'], $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
