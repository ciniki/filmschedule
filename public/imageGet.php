...
function ciniki_filmschedule_imageGet($ciniki) {
    ...
    $rc = ciniki_filmschedule_checkAccess($ciniki, $args['tnid'], 'ciniki.filmschedule.imageGet'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    $strsql = "SELECT ciniki_filmschedule_images.id, "
        ...
        . "WHERE ciniki_filmschedule_images.tnid = '" . ciniki_core_dbQuote($ciniki, $args['tnid']) . "' "
